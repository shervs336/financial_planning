<div class="card mb-4">
  ...
  <div class="card-body collapse" id="accumulationCard">
    ...
    <div class="card">
      <div class="card-header">
        <a href="#" data-toggle="collapse" data-target="#accumulationYearlyTableCard">Yearly Computation Table</a>
      </div>
      <div class="card-body collapse" id="accumulationYearlyTableCard">
        @if($client->accumulation)
          <div class="table-responsive">
            <table class="table table-bordered table-condensed">
              <thead>
      ...
      <div class="card mb-4 mt-1">
        <div class="card-header">
          <a href="#" data-toggle="collapse" data-target="#accumulationPayment">Payments</a>
        </div>
        <div class="card-body collapse" id="accumulationPayment">
          <div class="table-responsive">
            <table class="table table-bordered table-condensed">
              <thead>
                <tr>
