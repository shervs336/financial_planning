  ...
  <div class="card-header">
    ...
    @if(Auth::user()->role == "admin")
      @if($client->emergency_fund)
        ...
        <a href="{{ route('emergency_fund.pdf', [$client->id, $client->emergency_fund->id]) }}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" title="Print to PDF"><i class="fa fa-fw fa-print"></i></a>
